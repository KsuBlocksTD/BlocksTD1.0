...
public class PartyCommand {
    ...
    private static int helpCommandLogic (final CommandContext<CommandSourceStack> ctx){
        ...
        Bukkit.getScheduler().runTask(PluginTest.getInstance(), () -> sender.performCommand("party help "));
    ...
    private static int infoCommandLogic (final CommandContext<CommandSourceStack> ctx){
        ...
        Bukkit.getScheduler().runTask(PluginTest.getInstance(), () -> sender.performCommand("party info "));
